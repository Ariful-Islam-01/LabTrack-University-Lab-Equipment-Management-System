        ...
        <div class="col-md-8">
            ...
            <div class="mb-4">
                <h1 class="h3 mb-0 text-gray-800">
                    <i class="bi bi-person-gear me-2 text-primary"></i>Edit Teacher
                </h1>
            </div>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    <form action="{{ route('teachers.update', $teacher->user_id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')

                        <!-- Teacher ID (read-only) -->
                        <div class="mb-3">
                            <label for="user_id" class="form-label fw-semibold">Teacher ID</label>
                            <input type="text"
                        ...
                        <div class="mb-4">
                            ...
                            <select class="form-select @error('department') is-invalid @enderror"
                                ...
                                @foreach (['CSE', 'EEE', 'CE', 'ME', 'BBA'] as $dept)
                                    <option value="{{ $dept }}"
                                        {{ old('department', $teacher->department) === $dept ? 'selected' : '' }}>
                                        {{ $dept }}
                                    </option>
                                @endforeach
                            </select>
